//Scenario 1: CI/CD Pipeline Using Git + Jenkins + SonarQube + Docker + EC2 //
// Spring Boot application deployed on EC2 using Docker. //
...
// docker pull dockerhub.company.com/payment-app:45  //
/* docker stop payment-app
docker rm payment-app */


/* docker run -d \
--name payment-app \
-p 8080:8080 \
dockerhub.company.com/payment-app:45 */
